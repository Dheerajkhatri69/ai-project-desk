...
export function NavigationMenuDemo({
  ...
  const getColorClass = (progress: number) => {
    if (progress >= 75) return { bg: "bg-green-500", border: "border-green-500" };
    if (progress >= 50) return { bg: "bg-yellow-500", border: "border-yellow-500" };
              ...
              <div className="p-4 space-y-6">
                ...
                <div className="space-y-4">
                  {projects.map((project) => {
                    const { bg, border } = getColorClass(project.progress);
                    return (
                      <div
                        key={project.id}
